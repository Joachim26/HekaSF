...
void init(OptionsMap& o) {
  ...
  o["PawnForward"]           << Option(0, -1000, 1000);
  o["AttackBase"]            << Option(0, -1000, 1000);
  o["AttackCentre"]          << Option(0, -1000, 1000);
  o["PawnChains"]            << Option(0, -1000, 1000);
  o["HuntKing"]              << Option(0, -1000, 1000);
  o["HuntQueen"]             << Option(0, -1000, 1000);
  o["HuntRook"]              << Option(0, -1000, 1000);
  o["HuntBishop"]            << Option(0, -1000, 1000);
  o["HuntKnight"]            << Option(0, -1000, 1000);
